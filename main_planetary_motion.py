...
planetList = ['Earth', 'Jupiter', 'Sun']  # List of planets to use in the simulation. 'sun' MUST be the last element of the list or total momentum will not be 0.
